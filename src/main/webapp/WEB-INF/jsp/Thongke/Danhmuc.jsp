...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="# " target="_blank">
            <img src="https://png.pngtree.com/template/20190716/ourlarge/pngtree-creative-initial-letter-n-circle-color-logo-vector-linear-circle-letter-image_228209.jpg">
                        ...
                        <div class="table-responsive p-0">
                            <table class="table table-dark table-hover table-striped">
                                ...
                                <c:forEach var="listSanPham" items="${listSanPham}">
                                    <tr>
                                        <td style="padding-left: 25px">${listSanPham.tenLoaiSp}</td>
                                        <td style="padding-left: 25px"><c:choose>
