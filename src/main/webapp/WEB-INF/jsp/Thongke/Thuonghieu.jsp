                        ...
                        <div class="table-responsive p-0">
                            <table class="table table-hover table-dark table-striped">
                                ...
                                <c:forEach var="listHieuSanPham" items="${listHieuSanPham}">
                                    <tr>
                                        <td style="padding-left: 25px">${listHieuSanPham.tenHieuSanPham}</td>
                                        <td>
                                            <c:choose>
                                                <c:when test="${listHieuSanPham.hinhAnhHieuSanPham == null}">Chưa có logo</c:when>
                                                <c:otherwise>
                                                    <img class="logobrand" src="../../../uploadImageBrand/${listHieuSanPham.hinhAnhHieuSanPham}" alt="logo_brand" width="100px" height="100px"/>
                                                </c:otherwise>
                                            </c:choose>
                                        </td>
