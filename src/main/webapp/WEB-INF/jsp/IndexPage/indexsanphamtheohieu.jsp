    ...
    <div class="header_section">
        <div class="container">
            <div class="containt_main">
                ...
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Danh mục
                    </button>
                        ...
                        <ul>
                            ...
                            <c:when test="${userCurrent != 'anonymousUser'}">
                                ...
                                <div style=" margin-left: 10px" class="dropdown">
                                    ...
                                    <a style="color: #FFF; margin-left: -5px; text-transform: uppercase" class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${userCurrent}
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
...
<div style="padding-top: 30px" class="fashion_section">
    <div class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="container">
                    <h1 style="color: #ff6400" class="fashion_taital" id="title">${tenHieuSanPham.tenHieuSanPham}</h1>
                        ...
                        <div class="carousel slide" data-ride="carousel" style="position: static">
                            <div class="carousel-inner">
                                <div class="carousel-item active" style="display: flex; overflow: hidden; scroll-snap-type: x mandatory;" id="scrollProducts" >
                                    <c:forEach var="sanpham" items="${listSanPhambyHieu}">
