...
CREATE TABLE `user_role` (
  ...
  CONSTRAINT `FKmow7bmkl6wduuutk26ypkgmm1` FOREIGN KEY (`user`) REFERENCES `user` (`id_khachhang`)
...
INSERT INTO `user_role` VALUES (1,2,59),(2,1,60),(4,2,64),(5,1,65),(6,2,66),(8,2,68);
